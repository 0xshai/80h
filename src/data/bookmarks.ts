...
export const bookmarks: Category[] = [
  { category: '编程工具', icon: '🛠️', items: [
    { name: 'Zed', url: 'https://zed.dev/', desc: '轻量极速的现代代码编辑器', opensource: true },
    { name: 'WezTerm', url: 'https://wezfurlong.org/wezterm', desc: '高性能跨平台终端模拟器', opensource: true },
  ...
  { category: '下载工具', icon: '⬇️', items: [
    ...
    { name: 'AB Download', url: 'https://abdownloadmanager.com', desc: '开源多线程下载加速，速度最高提升500%', opensource: true },
  ]},
  { category: '视频处理', icon: '🎬', items: [
    { name: 'LosslessCut', url: 'https://github.com/mifi/lossless-cut', desc: '无损视频剪切工具，不重新编码', opensource: true },
    { name: 'OBS Studio', url: 'https://obsproject.com', desc: '专业录屏与直播推流工具，跨平台开源', opensource: true },
    { name: 'HandBrake', url: 'https://handbrake.fr', desc: '开源视频转码压制工具，支持 AV1/H.265/H.264，跨平台免费', opensource: true },
    { name: 'MediaInfo', url: 'https://mediaarea.net/en/MediaInfo', desc: '视频与音频文件技术参数查看工具，编码、码率、色彩空间等信息一览无余', opensource: true },
    { name: 'CompressO', url: 'https://compresso.codeforreal.com/', desc: '跨平台视频与图片压缩工具，FFmpeg 驱动，本地运行不上传，支持批量处理', opensource: true },
  ]},
  { category: '视频播放', icon: '🎞️', items: [
  ...
  { category: '系统工具', icon: '⚙️', items: [
    { name: 'Everything', url: 'https://voidtools.com', desc: 'Windows 文件秒搜' },
    { name: 'Flow Launcher', url: 'https://flowlauncher.com', desc: 'Windows 快速启动工具', opensource: true },
    { name: 'Flameshot', url: 'https://flameshot.org', desc: '跨平台开源截图工具，支持标注与上传', opensource: true },
  ...
  { category: '邮箱', icon: '📬', items: [
    ...
    { name: 'Proton Mail', url: 'https://proton.me', desc: '端对端加密，瑞士服务器', opensource: true },
    { name: 'Tuta Mail', url: 'https://tuta.com', desc: '德国团队，连元数据都加密', opensource: true },
  ]},
  { category: '密码管理', icon: '🔐', items: [
    { name: 'Bitwarden', url: 'https://bitwarden.com', desc: '最好的开源密码管理器，可自托管', opensource: true },
    { name: 'Keyguard', url: 'https://github.com/AChep/keyguard-app', desc: 'Bitwarden 第三方客户端，界面更现代', opensource: true },
  ]},
  { category: '双因素认证', icon: '🔑', items: [
    { name: 'Aegis', url: 'https://getaegis.app', desc: 'Android 上最好的开源 2FA 应用', opensource: true },
  ...
  { category: '本地 AI', icon: '🤖', items: [
    ...
    { name: 'Jan', url: 'https://jan.ai', desc: '本地优先的 AI 客户端，内置聊天界面，可作为 Ollama 前端', opensource: true },
    { name: 'Ensu', url: 'https://ente.com/blog/ensu', desc: '本地运行的 AI 聊天，模型不联网，对话不离开设备', opensource: true },
    { name: 'Voicebox', url: 'https://voicebox.sh', desc: '开源本地 AI 语音工作室，声音克隆、全局听写、TTS 生成一体，数据不离本机，支持 MCP 接入 Claude', opensource: true },
  ]},
  { category: 'AI 工具', icon: '🧠', items: [
    { name: 'Agency-Agents', url: 'https://github.com/msitarzewski/agency-agents', desc: '200+ 专业 AI Agent 角色集合，覆盖工程、设计、营销等领域，兼容 Ollama 本地模型', opensource: true },
  ]},
];
